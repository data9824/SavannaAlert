...
./node_modules/.bin/electron-packager . SavannaAlert --platform=darwin --arch=x64 --version=0.36.12 --ignore pack --ignore src --ignore typings --ignore build --ignore .idea --ignore doc --out pack --overwrite
